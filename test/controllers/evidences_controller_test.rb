...
class EvidencesControllerTest < ActionController::TestCase
  ...
  test "should create evidence" do
    assert_difference('Evidence.count') do
      post :create, evidence: { comment: @evidence.comment, date_of_evidence: @evidence.date_of_evidence, description: @evidence.description }
    end
  ...
  test "should update evidence" do
    patch :update, id: @evidence, evidence: { comment: @evidence.comment, date_of_evidence: @evidence.date_of_evidence, description: @evidence.description }
    assert_redirected_to evidence_path(assigns(:evidence))
  end
