...
class PupilsControllerTest < ActionController::TestCase
  ...
  test "should create pupil" do
    assert_difference('Pupil.count') do
      post :create, pupil: { dob: @pupil.dob, family_name: @pupil.family_name, gender_ID: @pupil.gender_ID, given_name: @pupil.given_name }
    end
  ...
  test "should update pupil" do
    patch :update, id: @pupil, pupil: { dob: @pupil.dob, family_name: @pupil.family_name, gender_ID: @pupil.gender_ID, given_name: @pupil.given_name }
    assert_redirected_to pupil_path(assigns(:pupil))
  end
